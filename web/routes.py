...
def createJobCard():
    if request.method == "GET":
        ...
        return render_template(
            ...
            printingSuppliers=printingSuppliers,
            corrugationSuppliers=corrugationSuppliers,
            plateSuppliers=plateSuppliers,
            punchSuppliers=punchSuppliers,
            varnishSuppliers=varnishSuppliers,
            laminationSuppliers=laminationSuppliers,
            punchingSuppliers=punchingSuppliers,
            pastingSuppliers=pastingSuppliers,
        )
...
def paperSupplierMaster():
    ...
    return render_template(
        "masters/paper_suppliers_master.html", paperSuppliers=paperSuppliers
    )
...
def printingSupplierMaster():
    ...
    return render_template(
        "masters/printing_supplier_master.html", printingSuppliers=printingSuppliers
    )
...
def corrugationSupplierMaster():
    ...
    return render_template(
        "masters/corrugation_supplier_master.html",
        corrugationSuppliers=corrugationSuppliers,
    )
...
def addPapertype():
    ...
    paperRate = request.form["paperRate"]
    try:
        addPaperTypeDb(paperType, paperRate)
...
def generateReport():
    ...
    if request.method == "POST":
        ...
        jobWorks = getAllJobWork(startDate, endDate, **{k: v for k, v in arg.items()})
